...
public class T2andRskip extends Skip_LCSS{
	public T2andRskip(String inputFile, String outputFile, String verifyFile, double[] mst, int tableSize, int maxItemTableSize, double error, boolean isReduce) {
...
//
//	/* constructor */
//	public T2andRskip(String inputFile, String verifyFile, double mst, int tableSize, int maxItemTableSize, double error,boolean isReduce) {
...
//
//		System.out.println("algorithm : Rskip, " + "data : " + inputFile + ", mst : " + mst);
...
//	}
	...
	public void allSupportPlusOne(){
		...
		if(cmin != 0){
			...
			delta = cmin; // no entry is 0, so delta is same as cmin
...
//		System.out.println("algorithm : R skip");
