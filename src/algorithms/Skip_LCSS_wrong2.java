...
public class Skip_LCSS_wrong2 {
	...
	/* constructor */
	public Skip_LCSS_wrong2(String inputFile, String verifyFile, double mst, int tableSize) {
	...
	public void updateSummary(int[] transaction, ArrayList<int[]> hasAppearedInTable) {
		...
		replaceByCandidate(candidates,delta,cmin); // use candidate to replace entry in table
...
//		}
	...
	public void replaceByCandidate(ArrayList<int[]> candidates, int delta, int cmin) {
